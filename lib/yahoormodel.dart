...
class GetwithLocation {
    ...
    factory GetwithLocation.fromRawJson(String str) => GetwithLocation.fromJson(json.decode(str));

    String toRawJson() => json.encode(toJson());

    factory GetwithLocation.fromJson(Map<String, dynamic> json) => GetwithLocation(
...
class CurrentObservation {
    ...
    factory CurrentObservation.fromRawJson(String str) => CurrentObservation.fromJson(json.decode(str));
...
class Astronomy {
    ...
    factory Astronomy.fromRawJson(String str) => Astronomy.fromJson(json.decode(str));
...
class Atmosphere {
    ...
    factory Atmosphere.fromRawJson(String str) => Atmosphere.fromJson(json.decode(str));
